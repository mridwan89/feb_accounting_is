...
const PINTASAN = [
  ...
  { peran: ['STAF_KEUANGAN'], ke: '/faktur/baru', ikon: 'faktur', judul: 'Catat faktur pemasok', ket: 'Dicocokkan otomatis dengan PO dan LPB' },
  { peran: ['STAF_KEUANGAN'], ke: '/bkk/baru', ikon: 'keluar', judul: 'Buat bukti kas keluar', ket: 'Perintah bayar untuk Kasir' },
  ...
  { peran: ['KASUBAG_KEUANGAN'], ke: '/rekonsiliasi', ikon: 'timbang', judul: 'Rekonsiliasi bank', ket: 'Susun dan finalkan per bulan' },
  { peran: ['AUDITOR', 'KASUBAG_KEUANGAN'], ke: '/opname/baru', ikon: 'hitung', judul: 'Opname kas kecil', ket: 'Hitung fisik uang tunai' },
  { peran: ['AUDITOR'], ke: '/laporan/pengecualian', ikon: 'perisai', judul: 'Laporan pengecualian', ket: 'Transaksi yang perlu ditelaah' },
  { peran: ['WAKIL_DEKAN_2', 'DEKAN'], ke: '/laporan/faktur-jatuh-tempo', ikon: 'kalender', judul: 'Faktur jatuh tempo', ket: 'Rencana kebutuhan kas' },
